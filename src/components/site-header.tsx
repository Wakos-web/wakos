      ...
      <header className={"fixed inset-x-0 top-0 z-40 transition-all duration-300 " + headerBg} role="banner">
        <div className={"hidden items-center justify-between px-6 py-4 lg:flex xl:px-10 " + textColor}>
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="font-display text-2xl font-bold tracking-[0.18em] xl:text-3xl" style={{textShadow: "0 0 10px rgba(255,255,255,0.4), 0 0 20px rgba(255,255,255,0.2)"}}>{SCHOOL_NAME}</span>
          </Link>
        ...
        <div className={"flex items-center justify-between px-4 py-3 lg:hidden " + textColor}>
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-display text-xl font-bold tracking-[0.15em]" style={{textShadow: "0 0 8px rgba(255,255,255,0.4), 0 0 16px rgba(255,255,255,0.2)"}}>{SCHOOL_NAME}</span>
          </Link>
